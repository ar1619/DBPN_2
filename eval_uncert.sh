...
srun python eval_uncert.py --upscale_factor 16 --combination 2 --noise 0.001 --input_dir Input --output ../RDS/OCO-2 --test_dataset uncertainty --model weights/new_loss_post_tuning.pth
